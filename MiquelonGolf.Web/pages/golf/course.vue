...
const totalYardage = (tee: 'Blue' | 'White' | 'Red') =>
...
<template>
  <div>
    <PageHero title="Course Layout" subtitle="18 holes of public golf — open front nine, tight forest back nine." />
        ...
        <table class="w-full text-sm min-w-[600px]">
          ...
          <tbody v-if="holes">
            ...
            <tr class="bg-primary text-white font-bold text-sm">
              ...
              <td class="px-3 py-2.5"></td>
              <td class="px-3 py-2.5 text-center">{{ totalYardage('Blue') }}</td>
              <td class="px-3 py-2.5 text-center">{{ totalYardage('White') }}</td>
              <td class="px-3 py-2.5 text-center">{{ totalYardage('Red') }}</td>
            </tr>
          </tbody>
        </table>
      </div>
