        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YardageBlue = table.Column<int>(type: "int", nullable: false),
                    YardageWhite = table.Column<int>(type: "int", nullable: false),
                    YardageRed = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DiagramUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CartTrackage = table.Column<bool>(type: "bit", nullable: false),
                    SeasonalCartRental = table.Column<bool>(type: "bit", nullable: false),
                    FirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TeeTimeSlotId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    GolferName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GolferEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GolferPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_TeeTimeSlots_TeeTimeSlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TeeTimeSlotId",
                table: "Bookings",
                column: "TeeTimeSlotId");

            migrationBuilder.CreateIndex(
                name: "IX_Holes_HoleNumber",
                table: "Holes",
                column: "HoleNumber",
                unique: true);
